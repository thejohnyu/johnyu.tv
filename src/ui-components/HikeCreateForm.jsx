...
export default function HikeCreateForm(props) {
  ...
  const [coverImg, setCoverImg] = React.useState(initialValues.coverImg);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "HikeCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.coverImg ?? value;
          }
          if (errors.coverImg?.hasError) {
            runValidationTasks("coverImg", value);
          }
          setCoverImg(value);
        }}
        onBlur={() => runValidationTasks("coverImg", coverImg)}
        errorMessage={errors.coverImg?.errorMessage}
        hasError={errors.coverImg?.hasError}
        {...getOverrideProps(overrides, "coverImg")}
      ></TextField>
      <Flex
